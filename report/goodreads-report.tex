...
\begin{subtable}[l]{0.45\linewidth}
 \centering
 \input{../table/goodreads-topics-recommendations/book-tags.tex}
     \subcaption{\texttt{book\_tags.csv}}
    \label{tab:book-tags}
\end{subtable}%
\begin{subtable}[r]{0.45\linewidth}
 \centering
 \input{../table/goodreads-topics-recommendations/tags.tex} 
...
\begin{table}[h]
\centering
  \input{../table/goodreads-topics-recommendations/top-books-in-topic-7.tex}
...
\centering
 \input{../table/goodreads-topics-recommendations/top-tag-names-left.tex}
\end{subtable}
...
\centering
 \input{../table/goodreads-topics-recommendations/top-tag-names-right.tex} 
\end{subtable}
\end{table}
...
\begin{table}[p]
\centering
  \input{../table/goodreads-topics-recommendations/sci-fi-topic.tex}
...
\begin{subtable}[t]{\linewidth}
\centering
  \input{../table/goodreads-topics-recommendations/stephen-king-topics.tex}
...
\begin{subtable}[b]{\linewidth}
\centering
  \input{../table/goodreads-topics-recommendations/stephen-king-tags.tex}
...
\begin{table}[p]
\centering
  \input{../table/goodreads-topics-recommendations/user-recommendations-rated-9.tex}
...
\begin{table}[p]
\centering
  \input{../table/goodreads-topics-recommendations/user-recommendations-9.tex}
